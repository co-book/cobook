...
<html class="no-js">
   ...
   <!-- <script src="libs/jquery.min.js"></script> -->    
        ...
        <script src="resources/epub/libs/zip.min.js"></script>
        ...
        <!-- Full Screen -->
        <script src="resources/epub/libs/screenfull.min.js"></script>

        <!-- Render -->
        <script src="resources/epub/build/epub.js"></script>

        <!-- Hooks -->
        <script src="resources/epub/build/hooks.js"></script>

        <!-- Reader 
        <script src="js/reader.min.js"></script>-->
        <script src="resources/epub/build/reader.js"></script>
        <script src="resources/epub/cobookmark.js"></script>

        <!-- Plugins -->
         <script src="resources/epub/plugins/search.js"></script>
